document.addEventListener("DOMContentLoaded", () => {
	...
	const text1 =
		...
		text2 = "Мы желаем нашим милым женщинам счастья, любови, улыбок, добра, здоровья и благополучия. Пусть ваши мечты исполняются всё чаще, а близкие люди окружают вас теплом и поддержкой, заботой и взаимным вниманием. Тепла, солнца, радости, благополучия, уюта и счастьяВам и вашему дому. Пусть новыми красками играют привычные дни, а приятные чувства встречаются там, где их не ждешь. Музыки в сердце, музыки в душе, гармонии во всем! С 8 Марта!";
