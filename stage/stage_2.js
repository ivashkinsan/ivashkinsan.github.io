...
function create_select_contains(answers) {
    ...
    for (let item of obj_key_to_array) {
        ...
        row_contain.append(create_row_selects(obj_values_to_array, 0));
...
function create_row_selects(input, indx) {
    ...
    for (let i = 0; i < input.length; i++) {
        ...
        one_box_for_row.append(
            create_one_select_elem(input[i], input_to_arr[indx])
        );
