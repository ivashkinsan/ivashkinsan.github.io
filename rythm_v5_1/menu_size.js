...
const sizeMenu = new Object({
    ...
    'button': null,
    'thumbler': {
        'sixteenthNote_16': true,
        'eighthNote_8': true,
        'eighthNote_8_triple': false,
    },
    'contain': null,
    'elementsArr': [],
    createMenu() {
...
const proxyThumbler = new Proxy(sizeMenu.thumbler, {
    set(target, key, value) {
        target[key] = value;
        if(target[value] == 'sixteenthNote_16' && value == false){
            console.log('set target false');
