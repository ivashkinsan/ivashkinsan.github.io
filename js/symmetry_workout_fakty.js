...
//МАЖОРНЫЕ ТРЕЗВУЧИЯ
 ...
 `алгоритм построения мажорного трезвучия:`
 + `</br>` + `Aug(увеличенное) трезвучие с понижением на ПолуТон верхнего звука`,
 `алгоритм построения мажорного трезвучия:`
 ...
 `алгоритм построения мажорного трезвучия:`
 + `</br>` + `Мажорный кварт-секст (T6/4, S6/4, D6/4) аккорд с переносом нижнего звука на октаву вверх`,
 `алгоритм построения мажорного трезвучия:`
 ...
 `алгоритм построения мажорного трезвучия:`
 + `</br>` + `Aug(увеличенное) трезвучие с повышением ПолуТон нижнего звука`,
 `алгоритм построения мажорного трезвучия:`
 + `</br>` + `Aug(увеличенное) трезвучие с повышением всей верхней терции на ПолуТон`,
 `алгоритм построения мажорного трезвучия:`
 ...
 `алгоритм построения мажорного трезвучия:`
 + `</br>` + `минорный кварт-секст (t6/4, s6/4) аккорд с переносом нижнего звука на октаву вверх`
